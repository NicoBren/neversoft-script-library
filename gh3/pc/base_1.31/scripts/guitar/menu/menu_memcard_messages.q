...
script create_network_prompt_menu 
	...
	create_popup_warning_menu \{textblock = {
			text = "To track your performance against other players in the Leaderboards, you need an online account."
			dims = (800.0, 400.0)
			scale = 0.5
		}
		TextElement = {
...
script create_autologin_prompt_menu 
	memcard_cleanup_messages
	create_popup_warning_menu \{textblock = {
			text = "Do you want to automatically login each time you run Guitar Hero III? You can change your selection under the Options Menu later."
			dims = (800.0, 400.0)
			scale = 0.5
		}
		menu_pos = (640.0, 480.0)
...
script create_signin_warning_menu 
	memcard_cleanup_messages
	create_popup_warning_menu \{textblock = {
			text = "Your performance will not be tracked in the Leaderboards until you go Online."
		}
		menu_pos = (640.0, 480.0)
...
script create_no_save_found_menu 
	memcard_cleanup_messages
	create_popup_warning_menu \{textblock = {
			text = "No GUITAR HERO III save data found."
		}
		menu_pos = (640.0, 480.0)
		dialog_dims = (288.0, 64.0)
		options = [
