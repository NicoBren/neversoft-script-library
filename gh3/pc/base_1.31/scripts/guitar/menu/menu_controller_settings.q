...
script winport_create_p1_controller_popup 
	create_popup_warning_menu \{title = "Select Controller"
		textblock = {
			text = "Press any button on the controller to be used in single player mode and in the menus."
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
...
script winport_create_bind_buttons_popup 
	create_popup_warning_menu \{title = "Select Controller"
		textblock = {
			text = "Press any button on the controller you want to configure."
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
