...
script create_jam_song_select_menu \{curr_tab = 0
	...
	jam_update_curr_directory_listing ($primary_controller)
	if (<curr_tab> = 0)
...
script create_jam_play_select_menu 
	...
	suffix = '_size'
	GetSongInfo
	if ((IsGuitarController controller = $primary_controller) || (<normal_controller> = 1))
	...
	if ((IsDrumController controller = $primary_controller) || (<normal_controller> = 1))
	...
	if (<normal_controller> = 1 && has_USB_mic_plugged_in)
