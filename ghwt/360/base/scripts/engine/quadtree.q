...
script render_nonskinnedinstances_toggle 
	if ($rendernonskinnedinstances = 0)
		change \{rendernonskinnedinstances = 1}
	else
		change \{rendernonskinnedinstances = 0}
	endif
endscript
