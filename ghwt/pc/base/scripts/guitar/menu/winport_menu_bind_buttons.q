...
script winport_create_bind_buttons 
	...
	add_user_control_helper \{text = qs("BACK")
		button = red
		z = 100}
	add_user_control_helper \{text = qs("UP/DOWN")
		button = strumbar
		z = 100}
endscript
...
script winport_get_keyboard_text \{deviceNum = 0
		actionNum = -1}
	if (<actionNum> > -1)
		keyText = qs("")
		...
		switch (<controlNum>)
			...
			WinPortControlNameNCopy string = <controlName> length = 1
			keyText = <new_string>
			keyPosOffset = (2.5, 0.0)
			case 213
			case 234
			WinPortSioGetControlName deviceNum = <deviceNum> controlNum = <controlNum>
			WinPortControlNameNCopy string = <controlName> length = 1
			keyText = <new_string>
			keyPosOffset = (1.0, -2.0)
			case 219
			WinPortSioGetControlName deviceNum = <deviceNum> controlNum = <controlNum>
			WinPortControlNameNCopy string = <controlName> length = 1
			keyText = <new_string>
			...
			case 245
			WinPortSioGetControlName deviceNum = <deviceNum> controlNum = <controlNum>
			WinPortControlNameNCopy string = <controlName> length = 2
			keyText = <new_string>
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (2.0, 0.4)
			case 246
			case 247
			case 248
			WinPortSioGetControlName deviceNum = <deviceNum> controlNum = <controlNum>
			WinPortControlNameNCopy string = <controlName> length = 3
			keyText = <new_string>
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			...
			keyFont = fontgrid_text_a8
			keyScale = 0.5
			keyPosOffset = (1.0, 3.4)
			case 273
			case 320
			WinPortSioGetControlName deviceNum = <deviceNum> controlNum = <controlNum>
			WinPortControlNameNCopy string = <controlName> length = 1
			keyText = <new_string>
			keyPosOffset = (3.0, -2.0)
			case 274
			WinPortSioGetControlName deviceNum = <deviceNum> controlNum = <controlNum>
			WinPortControlNameNCopy string = <controlName> length = 1
			keyText = <new_string>
			keyPosOffset = (3.0, 4.0)
			case 282
			keyText = qs(0x7a36391e)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 283
			keyText = qs(0x632d085f)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (0.5, 0.4)
			case 284
			keyText = qs(0x48005b9c)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 285
			keyText = qs(0x511b6add)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 286
			keyText = qs(0x1e5afc1a)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 287
			keyText = qs(0x0741cd5b)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 288
			keyText = qs(0x2c6c9e98)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 289
			keyText = qs(0x3577afd9)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 290
			keyText = qs(0xb2efb316)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 291
			keyText = qs(0xabf48257)
			keyFont = fontgrid_text_a11
			keyFontSpacing = 2
			keyScale = 0.4
			keyPosOffset = (-0.5, 0.4)
			case 308
			keyText = qs(0xbc941ee5)
			default
			WinPortSioGetControlName deviceNum = <deviceNum> controlNum = <controlNum>
			WinPortControlNameNCopy string = <controlName> length = 1
			keyText = <new_string>
		endswitch
		return {keyText = <keyText> keyFont = <keyFont> keyScale = <keyScale> keyPosOffset = <keyPosOffset> keyFontSpacing = <keyFontSpacing>}
	else
