...
script init_rotate_widget 
	...
	GetArraySize <backing_children>
	backing_child_num = <array_size>
	k = 0
	begin
...
script up_rotate_widget 
	...
	<widget_id> :SetTags {value = <value>}
	printf \{channel = sfx
		qs("\LPLAYING Menu_EnterName_Scroll_3.2")}
...
script down_rotate_widget 
	...
	<widget_id> :SetTags {value = <value>}
	printf \{channel = sfx
		qs("\LPLAYING Menu_EnterName_Scroll_3.3")}
	PlaySound \{Menu_EnterName_Scroll_3
		vol_percent = 100
		buss = front_end}
	<pad_down_script> {<pad_down_params> value = <value>}
