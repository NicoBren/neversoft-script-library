...
script get_heap_sizes 
	...
	switch <platform>
		...
		<heap_size_bink_in_cas> = (3 * 1024 * 1024)
		...
		<heap_size_pak_cache> = ((20 * 1024 * 1024) + (800 * 1024))
		<heap_size_pak_cache_vram> = (0 * 1024 * 1024)
		<heap_size_save_file> = ((2 * 1024 * 1024) + (10 * 1024))
		<heap_size_save_file_vram> = 0
		case ps3
		<heap_size_globalpak> = (3200 * 1024)
		<heap_size_globalpak_vram> = ((22 * 1024 * 1024) + (100 * 1024))
		...
		<heap_size_musician_vram> = (10000 * 1024)
		<heap_size_ragskel> = (400 * 1024)
		<heap_size_musician_anim> = (24 * 1024 * 1024)
		<heap_size_havok> = (3 * 1024 * 1024)
		<heap_size_downloads> = (256 * 1024)
		<heap_size_downloads_vram> = (768 * 1024)
		<heap_size_global_cas> = ((9 * 1024 * 1024) + (400 * 1024))
		<heap_size_global_cas_vram> = (19 * 1024 * 1024)
		<heap_size_cas> = (20 * 1024 * 1024)
		<heap_size_cas_vram> = (50 * 1024 * 1024)
