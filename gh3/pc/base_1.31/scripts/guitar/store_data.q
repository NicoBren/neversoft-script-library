...
Bonus_Videos = [
	{
		...
		info = "The Sex Pistols re-enter the studio for the first time since 1977 to record a new version of 'Anarchy in the U.K.' just for Guitar Hero 3."
		price = 1500
	}
	{
		id = brettmichaels
		name = "Bret Michaels"
		info = "Bret Michaels motion captured some of his signature moves for the singer in the game.  Check out his visit to Neversoft where he donned the mo-cap suit to capture his stage presence."
		price = 1500
	}
	{
		id = slash
		name = "Slash"
		info = "Go behind the scenes as legendary guitar hero Slash finds out what it takes to be a boss in the game.  Go into the studio as Slash lays down a track of some dueling guitars."
		price = 1500
	}
	{
		id = tommorello
		name = "Tom Morello"
		info = "Tom Morello brings his innovative playing techniques as the first boss you'll ever encounter in Guitar Hero.  Go behind the scenes as Tom composes new solo work just for the game."
		price = 1500
	}
]
store_song_data = {
