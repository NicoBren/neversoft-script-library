...
script CreateGuitarTapTrail 
	...
	CreateMaterial {
		...
		MaterialProps = [
			...
			{name = m_psColors0 VectorProperty = [9.0 9.0 9.0 1.0]}
			{name = m_psColors1 VectorProperty = [-3.0 -3.0 -3.0 0.5]}
...
script generate_pos_table 
	...
	SetProjectSpecificSpriteParams HighwayStartFade = <fs> HighwayEndFade = <fe>
